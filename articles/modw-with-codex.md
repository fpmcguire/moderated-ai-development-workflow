...
This document should define (Codex) AGENTS.md, including the specific prompts, context, and guidelines for how Codex will review and generate code, tests, and documentation based on
...
The Moderator will need to manually copy/paste the relevant content from the above files into ARCHITECTURE.md, DOMAIN_LANGUAGE.md, and the (Codex) AGENTS.md template
