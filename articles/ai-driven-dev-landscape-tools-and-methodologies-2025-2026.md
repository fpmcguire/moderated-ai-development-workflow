# AI-Assisted & Automated Product and Code Production Workflows
...
Idea / Product Brief
       ↓
[Methodology] SDD / Moderated AI Development (MAID) / BMAD  ←→  defines the workflow structure, roles, and governance
       ↓
...
A mature team might use **Moderated AI Development (MAID)** as the governance methodology, **Kiro** or **Spec Kit** to generate specs, **Cursor** or **Claude Code** for implementation, and **Devin** or **OpenAI Codex** for parallelized, unattended execution of well-defined tickets.

---

## Methodology Comparison: SDD vs. Moderated AI Development (MAID) vs. BMAD

These three methodologies are related but serve different team profiles and priorities:

| Dimension             | SDD                     | Moderated AI Development (MAID)                  | BMAD                                 |
| --------------------- | ----------------------- | ------------------------------------------------ | ------------------------------------ |
...
| Spec-first, team discipline       | Kiro, GitHub Spec Kit, Moderated AI Development (MAID) , BMAD                        |
| Quality & traceability focus      | Moderated AI Development (MAID) + Kiro or Moderated AI Development (MAID) + Spec Kit |
...
| Open-source / self-hosted         | Aider, Continue.dev, BMAD Method, Moderated AI Development (MAID), Sweep AI          |
...
9. [README.md](https://github.com/fpmcguire/moderated-ai-development/blob/main/README.md)
