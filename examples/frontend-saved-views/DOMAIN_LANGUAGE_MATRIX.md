...
| Step | Delivery | Small, verifiable unit of work in MAID | One slice of progress that can be explained to others | One iteration through the MAID Step lifecycle | Roadmap step | Ticket, task | Moderator | ROADMAP.md | `step-01`, `step-02` tags & files | Always small enough for one iteration |
