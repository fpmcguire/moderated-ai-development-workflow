...
**Is Moderated AI Development a replacement for Agile or Scrum?**  
No. Moderated AI Development is a complementary framework that can be layered on top of Agile, Scrum, Kanban, or any other delivery methodology. MAID focuses specifically on the AI-assisted development workflow within a team's existing process.

**Do I need to use a specific AI model?**  
No. Moderated AI Development is model-agnostic. The prompt templates provide versions for ChatGPT and Claude, but the principles apply to any AI model. Adapt the prompts to your chosen tool.

**Does Moderated AI Development work for solo developers?**  
...
No. Moderation must be performed by a qualified human. Using one AI to evaluate another AI's output does not satisfy the MAID quality gate. The human moderator must understand and personally vouch for the accepted artifact.
...
Yes. Prompts are first-class artifacts in MAID and should be stored alongside the artifacts they produce. This enables traceability, reproducibility, and team learning.
